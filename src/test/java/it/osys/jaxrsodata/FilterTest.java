...
public class FilterTest extends HSQLDBInitialize {
	...
	public void getNullLocalDateTimeField() {
		...
		List<TestEntity> result = getFilteredResults(filter);
		Assertions.assertEquals(2, result.size());
		Assertions.assertNull(result.get(0).getLocalDateTimeType());
	...
	public void getNullStringField() {
		...
		List<TestEntity> result = getFilteredResults(filter);
		Assertions.assertEquals(1, result.size());
		Assertions.assertNull(result.get(0).getStringType3());
		Assertions.assertEquals(Long.valueOf(1), result.get(0).getId());
	}
	...
	public void getNotNullStringField() {
		...
		List<TestEntity> result = getFilteredResults(filter);
		Assertions.assertEquals(3, result.size());
		Assertions.assertEquals("string", result.get(0).getStringType3());
		Assertions.assertEquals(Long.valueOf(2), result.get(0).getId());
	}
	...
	public void getFieldEQString() {
		...
		List<TestEntity> result = getFilteredResults(filter);
		Assertions.assertEquals(1, result.size());
		Assertions.assertEquals("app1", result.get(0).getStringType1());
		Assertions.assertEquals(Long.valueOf(1), result.get(0).getId());
	}
	...
	public void getFieldEQInteger() {
		...
		List<TestEntity> result = getFilteredResults(filter);
		Assertions.assertEquals(1, result.size());
		Assertions.assertEquals(1, result.get(0).getVersion());
		Assertions.assertEquals(Long.valueOf(1), result.get(0).getId());
	}
	...
	public void getFieldEQLocalDateTime() {
		...
		List<TestEntity> result = getFilteredResults(filter);
		Assertions.assertEquals(1, result.size());
		Assertions.assertEquals(LocalDateTime.parse("2017-01-01T13:00:00"), result.get(0).getLocalDateTimeType());
		Assertions.assertEquals(Long.valueOf(1), result.get(0).getId());
	}
	...
	public void getFieldEQEnum() {
		...
		List<TestEntity> result = getFilteredResults(filter);
		Assertions.assertEquals(1, result.size());
		Assertions.assertEquals(TestEnumEntity.Enum1, result.get(0).getEnumType());
		Assertions.assertEquals(Long.valueOf(1), result.get(0).getId());
	}
	...
	public void getFieldNEString() {
		...
		List<TestEntity> result = getFilteredResults(filter);
		Assertions.assertEquals(3, result.size());
		Assertions.assertEquals("app2", result.get(0).getStringType1());
		Assertions.assertEquals(Long.valueOf(2), result.get(0).getId());
	}
	...
	public void getFieldNEInteger() {
		...
		List<TestEntity> result = getFilteredResults(filter);
		Assertions.assertEquals(3, result.size());
		Assertions.assertEquals(2, result.get(0).getVersion());
		Assertions.assertEquals(Long.valueOf(2), result.get(0).getId());
	}
	...
	public void getFieldNEEnum() {
		...
		List<TestEntity> result = getFilteredResults(filter);
		Assertions.assertEquals(3, result.size());
		Assertions.assertEquals(TestEnumEntity.Enum2, result.get(0).getEnumType());
		Assertions.assertEquals(Long.valueOf(2), result.get(0).getId());
	}
	...
	public void getFieldGTLocalDateTime() {
		...
		List<TestEntity> result = getFilteredResults(filter);
		Assertions.assertEquals(1, result.size());
		Assertions.assertEquals(LocalDateTime.parse("2017-01-02T12:00:00"), result.get(0).getLocalDateTimeType());
		Assertions.assertEquals(Long.valueOf(2), result.get(0).getId());
	}
	...
	public void getFieldGTLocalTime() {
		...
		List<TestEntity> result = getFilteredResults(filter);
		Assertions.assertEquals(1, result.size());
		Assertions.assertEquals(Long.valueOf(4), result.get(0).getId());
	}
	...
	public void getFieldGEInteger() {
		...
		Assertions.assertEquals(1, result.get(0).getVersion());
		Assertions.assertEquals(Long.valueOf(1), result.get(0).getId());
		Assertions.assertEquals(2, result.get(1).getVersion());
		Assertions.assertEquals(Long.valueOf(2), result.get(1).getId());
		Assertions.assertEquals(3, result.get(2).getVersion());
	...
	public void getFieldGELocalDateTime() {
		...
		Assertions.assertEquals(LocalDateTime.parse("2017-01-01T13:00:00"), result.get(0).getLocalDateTimeType());
		Assertions.assertEquals(Long.valueOf(1), result.get(0).getId());
		Assertions.assertEquals(LocalDateTime.parse("2017-01-02T12:00:00"), result.get(1).getLocalDateTimeType());
		Assertions.assertEquals(Long.valueOf(2), result.get(1).getId());
	}
	...
	public void testInString() {
		...
		List<TestEntity> result = getFilteredResults(filter);
		Assertions.assertEquals(2, result.size());
		Assertions.assertEquals("distribution_name", result.get(0).getStringType2());
		Assertions.assertEquals("distribution_name", result.get(1).getStringType2());
	}
	...
	public void getFieldTolowerEQString() {
		...
		List<TestEntity> result = getFilteredResults(filter);
		Assertions.assertEquals(2, result.size());
		Assertions.assertEquals("DISTRIBUTION_NAME_UP", result.get(0).getStringType2());
	}
	...
	public void getKeyFieldOfMap() {
		...
		Assertions.assertEquals(2, result.size());
		Assertions.assertEquals("distribution_name", result.get(0).getStringType2());
		Assertions.assertEquals("DISTRIBUTION_NAME_UP", result.get(1).getStringType2());
	}
